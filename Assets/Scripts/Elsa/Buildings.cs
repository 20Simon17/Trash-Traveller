...
public class Buildings : MonoBehaviour
{
    ...
    {
        #region Go Up
        if (collision.gameObject.tag == "House 1" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(-38.8f, 0, 13);
        }

        if (collision.gameObject.tag == "House 2" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(-35.5f, 1.79f, 13);
        }

        if (collision.gameObject.tag == "House 3" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(-27.2f, 2.26f, 13);
        }

        if (collision.gameObject.tag == "House 4" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(-14.9f, 0.06f, 13);
        }

        if (collision.gameObject.tag == "House 5" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            print("go up");
            transform.position = new Vector3(-11.4f, 2.4f, 13);
        }

        if (collision.gameObject.tag == "House 6" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(5.11f, -0.02f, 13);
        }

        if (collision.gameObject.tag == "House 7" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(18.84f, -0.04f, 13);
        }

        if (collision.gameObject.tag == "House 8" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(22, 2.53f, 13);
        }

        if (collision.gameObject.tag == "House 9" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
            transform.position = new Vector3(35.45f, 0.02f, 13);
        }

        if (collision.gameObject.tag == "House 10" && Input.GetKey(KeyCode.E) && transform.position.y < -1.7)
        {
        ...
        if (collision.gameObject.tag == "House 5" && Input.GetKey(KeyCode.E) && transform.position.y > 0)
        {
            print("go down");
